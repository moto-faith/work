...
class MySpider(spiderDefault.Spider):
    ...
    def __init__(self, cmd_args=None):
        ...
        self.info_flag = "01"
        # 网站名称
        self.siteName = '温州市实验中学	'
        # 网站一级域名
        self.site_domain = 'wems.net'

        self.start_urls = [
            # 列表页链接
            'http://wems.wzer.net/col/col3280/index.html',#校园新闻
            'http://wems.wzer.net/col/col3282/index.html',#教研动态
            'http://wems.wzer.net/col/col3281/index.html',#德育动态
            'http://wems.wzer.net/col/col3283/index.html',#媒体报道
            'http://wems.wzer.net/col/col3284/index.html',  #教育瞭望
            'http://wems.wzer.net/col/col3285/index.html',  #国际交流
            'http://wems.wzer.net/col/col3286/index.html',  #时政资讯
            'http://wems.wzer.net/col/col3287/index.html',  #图片传真
    ...
    def get_detail_page_urls(self, data):
        ...
        if data is not None:
            ...
            # loops = data.xpathall('''//ul[@id="newslist_522"]/li/a''')
            ...
            for item in re.findall("href='(.*?)' target='_blank'",data.response.text):
                ...
                # if not post_url:
                #     continue
                if 'wems.wzer.net' not in item:
                    post_url = urljoin("http://wems.wzer.net",item)
                else:
                    post_url = item
    ...
    def get_detail_page_info(self, data):
        ...
        content1 = data.xpathall('''//div[@class="text"]''')
        ...
        pic_urls_list = data.xpathall('''//div[@class="text"]//img/@src''')
        if pic_urls_list:
