...
class MySpider(spiderDefault.Spider):
    ...
    def __init__(self, cmd_args=None):
        ...
        self.info_flag = "01"
        # 网站名称
        self.siteName = '东昌府区人民政府'
        # 网站一级域名
        self.site_domain = 'dongchangfu.gov.cn'

        self.start_urls = [
            # 列表页链接
            'http://www.dongchangfu.gov.cn/ywdt/jryw/',#今日要闻
            'http://www.dongchangfu.gov.cn/ywdt/bmdt/',#部门动态
            'http://www.dongchangfu.gov.cn/ywdt/zjdt/',# 镇街动态
            'http://www.dongchangfu.gov.cn/ywdt/tzgg/',#通知公告
    ...
    def get_detail_page_urls(self, data):
        ...
        if data is not None:
            ...
            loops = data.xpathall('''//li[@class="item"]/a''')
