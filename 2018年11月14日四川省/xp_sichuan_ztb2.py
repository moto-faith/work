...
class MySpider(spider.Spider):
    ...
    def parse(self, response, url):
        ...
        #     urls = []
        page_urls = []
        urls = self.db.table(self.result1).where('''tf = "1" and siteName = "四川省公共资源交易中心"''').find()
    ...
    def parse_detail_page(self, response=None, url=None):
        ...
        if data:
            ...
            contents = data.xpathall (
                '''//div[@class="ContentMiddle"]//text()''')  # 内容
            content = ''
            for i in contents:
...
if __name__ == '__main__':
    ...
    # ------------ parse() ----------
    print "开始登录"
    url = "http://www.scggzy.gov.cn/Info/ProjectDetail/F_daefcc8a-2f1b-45ad-96be-9828a4dd9565.html"
