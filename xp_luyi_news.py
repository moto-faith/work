...
class MySpider(spiderDefault.Spider):
    ...
    def __init__(self, cmd_args=None):
        ...
        self.info_flag = "01"
        # 网站名称
        self.siteName = '鹿邑县人民政府网'
        # 网站一级域名
        self.site_domain = 'luyi.gov.cn'
    ...
    def get_detail_page_info(self, data):
        ...
        content1 = data.xpathall('''//div[@id="rightbox"]/p''')
