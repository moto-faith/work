...
class MySpider(spiderDefault.Spider):
    ...
    def __init__(self, cmd_args=None):
        ...
        self.info_flag = "01"
        # 网站名称
        self.siteName = '中国义乌政府门户网站'
        # 网站一级域名
        self.site_domain = 'yiwu.gov.cn'

        self.start_urls = [
            # 列表页链接
            'http://www.yw.gov.cn/11330782002609848G/a/zxyw/mryw/index.html',# 义乌要闻
            'http://www.yw.gov.cn/11330782002609848G/a/zxyw/bmdt/index.html',#部门动态
            'http://www.yw.gov.cn/11330782002609848G/a/zxyw/zjhd/index.html',#镇街动态
            'http://www.yw.gov.cn/11330782002609848G/a/zxyw/gggs/index.html',  #公告公示
            'http://www.yw.gov.cn/11330782002609848G/a/zxyw/scdjt/index.html',#商城大讲堂
        ]
        # 网页编码
        # 例：self.encoding = 'gbk'
        self.encoding = 'utf-8'
    ...
    def get_detail_page_urls(self, data):
        ...
        if data is not None:
            ...
            loops = data.xpathall('''//ul[@class="yg_section"]/li/a''')
    ...
    def get_detail_page_info(self, data):
        ...
        retweeted_source =data.xpath('''//mate[@name="ContentSource"]/@content''').text().strip() or self.siteName
        ...
        content1 = data.xpathall('''//div[@class="article"]''')
        ...
        pic_urls_list = data.xpathall('''//div[@class="article"]//img/@src''')
        if pic_urls_list:
