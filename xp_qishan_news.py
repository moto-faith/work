...
class MySpider(spiderDefault.Spider):
    ...
    def __init__(self, cmd_args=None):
        ...
        self.info_flag = "01"
        # 网站名称
        self.siteName = '岐山县人民政府	'
        # 网站一级域名
        self.site_domain = 'qishan.gov.cn'

        self.start_urls = [
            # 列表页链接
            'http://www.qishan.gov.cn/html/xwzx/zwyw/index.html',#政务要闻
            'http://www.qishan.gov.cn/html/xwzx/bmdt/index.html',#部门动态
            'http://www.qishan.gov.cn/html/xwzx/gzkx/index.html',# 各镇快讯
            'http://www.qishan.gov.cn/html/xwzx/gsgg/index.html',#公示公告
            'http://www.qishan.gov.cn/html/xwzx/tpxw/index.html',#图片新闻
        ]
        # 网页编码
        # 例：self.encoding = 'gbk'
        self.encoding = 'utf-8'
    ...
    def get_detail_page_urls(self, data):
        ...
        if data is not None:
            ...
            loops = data.xpathall('''//div[@class="list"]//a''')
    ...
    def get_detail_page_info(self, data):
        ...
        retweeted_source =data.xpath('''//span[@id="laiyuan"]//text()''').text().strip() or  self.siteName
        ...
        content1 = data.xpathall('''//div[@class="b"]''')
        ...
        pic_urls_list = data.xpathall('''//div[@class="b"]//img/@src''')
        if pic_urls_list:
