...
class MySpider(spider.Spider):
    def __init__(self,
        ...
        # 网站名称
        self.siteName = "江西公共资源交易网"
        # 类别码，01新闻、02论坛、03博客、04微博 05平媒 06微信  07 视频、99搜索引擎
        self.info_flag = "99"

        # 入口地址列表
        # self.start_urls = ["http://www.bidcenter.com.cn/viplist-1.html"]
        self.start_urls = ["http://ggzyweb.jiangxi.gov.cn"]
        self.encoding = 'utf-8'
        self.site_domain = 'ggzyweb.jiangxi.gov.cn'
        self.dedup_uri = None
        self.headers = {
    ...
    def parse(self, response, url):
        ...
        #     return ([], None, None)
        url_list = [
            'http://ggzyweb.jiangxi.gov.cn/web/jyxx/002001/002001001/jyxx.html',
            'http://ggzyweb.jiangxi.gov.cn/web/jyxx/002002/002002002/jyxx.html',
            'http://ggzyweb.jiangxi.gov.cn/web/jyxx/002003/002003001/jyxx.html',
            'http://ggzyweb.jiangxi.gov.cn/web/jyxx/002005/002005001/jyxx.html',
            'http://ggzyweb.jiangxi.gov.cn/web/jyxx/002006/002006001/jyxx.html',
            # 招标公告

            'http://ggzyweb.jiangxi.gov.cn/web/jyxx/002001/002001002/jyxx.html',
            'http://ggzyweb.jiangxi.gov.cn/web/jyxx/002003/002003002/jyxx.html',
            'http://ggzyweb.jiangxi.gov.cn/web/jyxx/002005/002005002/jyxx.html',
            'http://ggzyweb.jiangxi.gov.cn/web/jyxx/002006/002006002/jyxx.html',
            # 变更公告

            'http://ggzyweb.jiangxi.gov.cn/web/jyxx/002001/002001004/jyxx.html',
            'http://ggzyweb.jiangxi.gov.cn/web/jyxx/002002/002002005/jyxx.html',
            'http://ggzyweb.jiangxi.gov.cn/web/jyxx/002003/002003004/jyxx.html',
            'http://ggzyweb.jiangxi.gov.cn/web/jyxx/002005/002005004/jyxx.html',
            'http://ggzyweb.jiangxi.gov.cn/web/jyxx/002006/002006004/jyxx.html',
            # 中标公告
    ...
    def parse_detail_page(self, response=None, url=None):
        ...
        # dates = re.findall('<td width="120" align="right" valign="top">(.*?)<', unicode_html_body, re.S)
        # links = re.findall("href='\.\./\.\.(.*?)'", unicode_html_body)

        li_content = data.xpathall('''//div[@class="ewb-infolist"]//li''')
...
#         dates = data.xpathall('//span[@class="article-list-date"]/text()')
    ...
    def getdumps(self, url):
        if self.conn.sismember("dumps:jiangxi", url):
            return True  # 在里面
        else:
            print "入redis：去重库"
            self.conn.sadd("dumps:jiangxi", url)
            return False
