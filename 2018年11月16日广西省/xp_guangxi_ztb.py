...
class MySpider(spider.Spider):
    def __init__(self,
        ...
        # 网站名称
        self.siteName = "广西壮族自治区公共资源交易中心"
        # 类别码，01新闻、02论坛、03博客、04微博 05平媒 06微信  07 视频、99搜索引擎
        self.info_flag = "99"

        # 入口地址列表
        # self.start_urls = ["http://www.bidcenter.com.cn/viplist-1.html"]
        self.start_urls = ["http://www.gxzbtb.cn"]
        self.encoding = 'utf-8'
        self.site_domain = 'gxzbtb.cn'
        self.dedup_uri = None
        self.headers = {
    ...
    def parse(self, response, url):
        ...
        #     return ([], None, None)
        url_list = [
            'http://www.gxzbtb.cn/gxzbw/showinfo/MoreInfo.aspx?QuYu=450001&categoryNum=001010001',
            # 铁路工程招标公告

            'http://www.gxzbtb.cn/gxzbw/showinfo/MoreInfo.aspx?QuYu=450001&categoryNum=001010002',
            # 铁路工程变更公告

            'http://www.gxzbtb.cn/gxzbw/showinfo/MoreInfo.aspx?QuYu=450001&categoryNum=001010004',
            # 铁路工程结果公告

            'http://www.gxzbtb.cn/gxzbw/showinfo/MoreInfo.aspx?QuYu=450001&categoryNum=001001001',
            # 房建市政招标公告

            'http://www.gxzbtb.cn/gxzbw/showinfo/MoreInfo.aspx?QuYu=450001&categoryNum=001001002',
            # 房建市政变更公告

            'http://www.gxzbtb.cn/gxzbw/showinfo/MoreInfo.aspx?QuYu=450001&categoryNum=001001005',
            # 房建市政结果公告

            'http://www.gxzbtb.cn/gxzbw/showinfo/MoreInfo.aspx?QuYu=450001&categoryNum=001004001',
            # 政府采购招标公告

            'http://www.gxzbtb.cn/gxzbw/showinfo/MoreInfo.aspx?QuYu=450001&categoryNum=001004002',
            # 政府采购变更公告

            'http://www.gxzbtb.cn/gxzbw/showinfo/MoreInfo.aspx?QuYu=450001&categoryNum=001004004',
            # 政府采购中标公告
    ...
    def parse_detail_page(self, response=None, url=None):
        ...
        # links = re.findall('href="(.*?)" target="_blank" title="',unicode_html_body)
        # dates = re.findall('style="border-style:None;width:80px;">(.*?)</td>',unicode_html_body,re.S)[1:]
...
#         dates = data.xpathall('//span[@class="article-list-date"]/text()')
        if from_tag_url == "http://www.gxzbtb.cn/gxzbw/showinfo/MoreInfo.aspx?QuYu=450001&categoryNum=001010001":
            tag = "招标公告"
        elif from_tag_url == "http://www.gxzbtb.cn/gxzbw/showinfo/MoreInfo.aspx?QuYu=450001&categoryNum=001010002":
            tag = "变更通知"
        elif from_tag_url == "http://www.gxzbtb.cn/gxzbw/showinfo/MoreInfo.aspx?QuYu=450001&categoryNum=001010004":
            tag = "中标公告"
        elif from_tag_url == "http://www.gxzbtb.cn/gxzbw/showinfo/MoreInfo.aspx?QuYu=450001&categoryNum=001001001":
            tag = "招标公告"
        elif from_tag_url == "http://www.gxzbtb.cn/gxzbw/showinfo/MoreInfo.aspx?QuYu=450001&categoryNum=001001002":
            tag = "变更通知"
        elif from_tag_url == "http://www.gxzbtb.cn/gxzbw/showinfo/MoreInfo.aspx?QuYu=450001&categoryNum=001001005":
            tag = "中标公告"
        elif from_tag_url == "http://www.gxzbtb.cn/gxzbw/showinfo/MoreInfo.aspx?QuYu=450001&categoryNum=001004001":
            tag = "招标公告"
        elif from_tag_url == "http://www.gxzbtb.cn/gxzbw/showinfo/MoreInfo.aspx?QuYu=450001&categoryNum=001004002":
            tag = "变更通知"
        elif from_tag_url == "http://www.gxzbtb.cn/gxzbw/showinfo/MoreInfo.aspx?QuYu=450001&categoryNum=001004004":
            tag = "中标公告"
        else:
            tag = "招标公告"

        li_content = data.xpathall('''//table[@class="DataGrid"]//tr''')
        ...
        for item in li_content:
            ...
            date = item.xpath('''//td[@valign="middle"and @style="border-style:None;width:80px;"]/text()''').text ().strip ()

            link = 'http://www.gxzbtb.cn'+link
    ...
    def getdumps(self, url):
        if self.conn.sismember("dumps:gxzbtb", url):
            return True  # 在里面
        else:
            print "入redis：去重库"
            self.conn.sadd("dumps:gxzbtb", url)
            return False
...
if __name__ == '__main__':
    ...
    url = "http://www.gxzbtb.cn/gxzbw/showinfo/MoreInfo.aspx?QuYu=450001&categoryNum=001010001"
