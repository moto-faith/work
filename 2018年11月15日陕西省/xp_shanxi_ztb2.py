...
class MySpider(spider.Spider):
    ...
    def parse(self, response, url):
        ...
        #     urls = []
        page_urls = []
        urls = self.db.table(self.result1).where('''tf = "1" and siteName = "陕西省公共资源交易中心"''').find()
...
if __name__ == '__main__':
    ...
    # ------------ parse() ----------
    # print "开始登录"
    url = "http://www.sxggzyjy.cn/jydt/001001/001001001/001001001001/20181115/23e67e73-0883-41ce-8942-9d925ac1b583.html"
