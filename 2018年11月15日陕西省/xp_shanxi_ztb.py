...
class MySpider(spider.Spider):
    def __init__(self,
        ...
        # 网站名称
        self.siteName = "陕西省公共资源交易中心"
        # 类别码，01新闻、02论坛、03博客、04微博 05平媒 06微信  07 视频、99搜索引擎
        self.info_flag = "99"

        # 入口地址列表
        # self.start_urls = ["http://www.bidcenter.com.cn/viplist-1.html"]
        self.start_urls = ["http://www.sxggzyjy.cn"]
        self.encoding = 'utf-8'
        self.site_domain = 'sxggzyjy.cn'
        self.dedup_uri = None
        self.headers = {
    ...
    def parse(self, response, url):
        ...
        url_list = [
            ...
            'http://www.sxggzyjy.cn/jydt/001001/001001002/001001002001/subPage_jyxx.html',
            # 土地交易公告

            'http://www.sxggzyjy.cn/jydt/001001/001001002/001001002003/subPage_jyxx.html',
            # 土地变更公告

            'http://www.sxggzyjy.cn/jydt/001001/001001002/001001002002/subPage_jyxx.html',
            # 土地中标公告

            'http://www.sxggzyjy.cn/jydt/001001/001001003/001001003001/subPage_jyxx.html',
            # 国有产权交易公告

            'http://www.sxggzyjy.cn/jydt/001001/001001003/001001003002/subPage_jyxx.html',
            # 国有产权中标公告
    ...
    def parse_detail_page(self, response=None, url=None):
        ...
        # titles = re.findall('class="ewb-list-name ewb-otw" title="(.*?)"',unicode_html_body,re.S)
        # links = re.findall('<a href="(.*?)" class="ewb-list-name ewb-otw"', unicode_html_body,re.S)
        # dates = re.findall('class="ewb-list-date">(.*?)</span>',unicode_html_body,re.S)
...
#         dates = data.xpathall('//span[@class="article-list-date"]/text()')
        if from_tag_url == "http://www.sxggzyjy.cn/jydt/001001/001001001/001001001001/subPage_jyxx.html":
            ...
            tag = "中标公示"
        elif from_tag_url == "http://www.sxggzyjy.cn/jydt/001001/001001002/001001002001/subPage_jyxx.html":
            tag = "招标公告"
        elif from_tag_url == "http://www.sxggzyjy.cn/jydt/001001/001001002/001001002003/subPage_jyxx.html":
            tag = "变更公告"
        elif from_tag_url == "http://www.sxggzyjy.cn/jydt/001001/001001002/001001002002/subPage_jyxx.html":
            tag = "中标公告"
        elif from_tag_url == "http://www.sxggzyjy.cn/jydt/001001/001001003/001001003001/subPage_jyxx.html":
            tag = "招标公告"
        elif from_tag_url == "http://www.sxggzyjy.cn/jydt/001001/001001003/001001003002/subPage_jyxx.html":
            tag = "中标公告"
            ...
            tag = "招标公告"
        li_content = data.xpathall('''//li[@class="ewb-list-node clearfix"]''')
    ...
    def getdumps(self, url):
        if self.conn.sismember("dumps:sxggzyjy", url):
            return True  # 在里面
        else:
            print "入redis：去重库"
            self.conn.sadd("dumps:sxggzyjy", url)
            return False
...
if __name__ == '__main__':
    ...
    url = "http://www.sxggzyjy.cn/jydt/001001/001001001/001001001001/subPage_jyxx.html"
