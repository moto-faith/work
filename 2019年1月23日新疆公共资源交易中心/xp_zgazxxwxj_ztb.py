...
class MySpider(spider.Spider):
    ...
    def parse(self, response, url):
        ...
        #     return ([], None, None)
        url_list = [
            'http://www.zgazxxw.com/xj-000011l772-0.html',
            # 招标公告

            'http://www.zgazxxw.com/xj-000011l774-0.html',
            # 变更公告

            'http://www.zgazxxw.com/xj-000011l777-0.html',
            # 中标公告
    ...
    def getdumps(self, url):
        if self.conn.sismember("dumps:zgazxxwxj", url):
            return True  # 在里面
        else:
            print "入redis：去重库"
            self.conn.sadd("dumps:zgazxxwxj", url)
            return False
