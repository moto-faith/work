...
class MySpider(spider.Spider):
    def __init__(self,
        ...
        # 网站名称
        self.siteName = "湖南省公共资源交易中心"
        # 类别码，01新闻、02论坛、03博客、04微博 05平媒 06微信  07 视频、99搜索引擎
        self.info_flag = "99"

        # 入口地址列表
        # self.start_urls = ["http://www.bidcenter.com.cn/viplist-1.html"]
        self.start_urls = ["http://www.hnsggzy.com/"]
        self.encoding = 'utf-8'
        self.site_domain = 'hnsggzy.com'
        self.dedup_uri = None
        self.headers = {
    ...
    def parse(self, response, url):
        ...
        url_list = [
            ...
            'http://www.hnsggzy.com/queryContent-jygk.jspx?channelId=855',
            # 政府采购中标公告
    ...
    def parse_detail_page(self, response=None, url=None):
        ...
        links = re.findall('class="article-list3-t">.*?<a href="(.*?)"',unicode_html_body,re.S)
...
#         dates = data.xpathall('//span[@class="article-list-date"]/text()')
        if from_tag_url == "http://www.hnsggzy.com/queryContent-jygk.jspx?channelId=846&ext=%E6%8B%9B%E6%A0%87%2F%E8%B5%84%E5%AE%A1%E5%85%AC%E5%91%8A":
            ...
            tag = "变更通知"
        elif from_tag_url == "http://www.hnsggzy.com/queryContent-jygk.jspx?channelId=855":
            tag = "中标公告"
# 变更通知 中标公告/公示  招标公告
        else:
            tag = "招标公告"
    ...
    def getdumps(self, url):
        if self.conn.sismember("dumps:hnsggzy", url):
            return True  # 在里面
        else:
            print "入redis：去重库"
            self.conn.sadd("dumps:hnsggzy", url)
            return False
...
if __name__ == '__main__':
    ...
    url = "http://www.hnsggzy.com/queryContent-jygk.jspx?channelId=858"
