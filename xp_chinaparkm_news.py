...
class MySpider(spiderDefault.Spider):
    ...
    def __init__(self, cmd_args=None):
        ...
        self.info_flag = "01"
        # 网站名称
        self.siteName = '京津冀招商网'
        # 网站一级域名
        self.site_domain = 'chinaparkm.com'

        self.start_urls = [

            # 列表页链接
            'http://www.chinaparkm.com/class/18.html'
    ...
    def get_detail_page_urls(self, data):
        ...
        if data is not None:
            ...
            loops = data.xpathall('''//div[@class="langfangNavListAll"]//li''')
            for item in loops:  # 这时的item可以看做将解析到的模块当做新的网页打开，页面内只有解析到的模块，以解析的模块为顶级节点进行解析，而不再是标签
                ...
                ctime = item.xpath('''//div[@class="list1"]/span''').datetime()
    ...
    def get_detail_page_info(self, data):
        ...
        content1 = data.xpathall('''//div[@class="info1"]''')
