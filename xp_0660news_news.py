...
class MySpider(spiderDefault.Spider):
    ...
    def __init__(self, cmd_args=None):
        ...
        self.siteName = '汕尾新闻网'
        # 网站一级域名
        self.site_domain = '0660news.com'

        self.start_urls = [
            # 列表页链接
            'http://www.0660news.com/xiaofeizhuzhang/', #消费主张
            'http://www.0660news.com/guojiyaowen/',  # 国际要闻
            'http://www.0660news.com/kejixinwen/',  # 科技新闻
            'http://www.0660news.com/guoneiyule/',  # 国内娱乐
            'http://www.0660news.com/zixunmeiti/', # 资讯媒体
            'http://www.0660news.com/titanjieshuo/',# 体坛解说
            'http://www.0660news.com/guojiajunhun/', #国家军魂
            'http://www.0660news.com/shengcaiyoudao/',#生财有道
            'http://www.0660news.com/fangchandongtai/',#房产动态
            'http://www.0660news.com/youxirensheng/',#游戏人生
            'http://www.0660news.com/chejieguangqi/',#车界光启
            'http://www.0660news.com/jiankangxinwen/',#健康新闻
            'http://www.0660news.com/yidongshidai/',#移动时代
            'http://www.0660news.com/gangtaishixun/',#港台时讯
            'http://www.0660news.com/lanqiufazhan/',#篮球发展
            'http://www.0660news.com/zuhaizuoyou/',#足海遨游
            'http://www.0660news.com/dianshangjie/',  #电商界
            'http://www.0660news.com/lvyourenwen/',  #旅游人文
            'http://www.0660news.com/jiaoyuzaixian/',  #教育在线
            'http://www.0660news.com/muyingchaoliu/',  #母婴潮流
            'http://www.0660news.com/dushiliren/',  #都市丽人
            'http://www.0660news.com/lishidashi/',  #历史大事
            'http://www.0660news.com/xingyedongtai/',  #行业动态
            'http://www.0660news.com/xiaoliaobaichu/',  #笑料百出
            'http://www.0660news.com/duzhewujiang/',  #读者无疆
    ...
    def get_detail_page_urls(self, data):
        ...
        if data is not None:
            ...
            loops = data.xpathall('''//ul[@class="contentlist bian_0px"]//span[1]''')
            ...
            for item in loops:  # 这时的item可以看做将解析到的模块当做新的网页打开，页面内只有解析到的模块，以解析的模块为顶级节点进行解析，而不再是标签
                ...
                if not post_url:
                    continue
                # post_url = urljoin("http://www.nigame.com.cn",post_url)
    ...
    def get_detail_page_info(self, data):
        ...
        content1 = data.xpathall('''//div[@class="zhenwen"]''')
        ...
        pic_urls_list = data.xpathall('''//div[@class="zhenwen"]//img/@src''')
        if pic_urls_list:
