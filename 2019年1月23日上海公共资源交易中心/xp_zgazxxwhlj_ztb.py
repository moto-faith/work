...
class MySpider(spider.Spider):
    ...
    def parse(self, response, url):
        ...
        #     return ([], None, None)
        url_list = [
            'http://www.zgazxxw.com/sh-000011l772-0.html',
            # 招标公告

            'http://www.zgazxxw.com/sh-000011l774-0.html',
            # 变更公告

            'http://www.zgazxxw.com/sh-000011l777-0.html',
            # 中标公告
    ...
    def parse_detail_page(self, response=None, url=None):
        ...
        for item in li_content:
            ...
            year = re.findall('(\d{6})/.*?php',link)[0]
            date = '{}{}'.format(year[:4], date)
            publicTime = date
            ...
            link = urljoin("http://www.zgazxxw.com", link)
    ...
    def getdumps(self, url):
        if self.conn.sismember("dumps:zgazxxwsh", url):
            return True  # 在里面
        else:
            print "入redis：去重库"
            self.conn.sadd("dumps:zgazxxwsh", url)
            return False
