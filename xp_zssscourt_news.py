...
class MySpider(spiderDefault.Spider):
    ...
    def __init__(self, cmd_args=None):
        ...
        self.info_flag = "01"
        # 网站名称
        self.siteName = '浙江省嵊泗县人民法院'
        # 网站一级域名
        self.site_domain = 'zssscourt.cn'

        self.start_urls = [
            # 列表页链接
            'http://www.zssscourt.cn/index.php?m=content&c=index&a=lists&catid=71',
            'http://www.zssscourt.cn/index.php?m=content&c=index&a=lists&catid=70',
            'http://www.zssscourt.cn/index.php?m=content&c=index&a=lists&catid=72',
            'http://www.zssscourt.cn/index.php?m=content&c=index&a=lists&catid=74',
            'http://www.zssscourt.cn/index.php?m=content&c=index&a=lists&catid=75'
        ]
        # 网页编码
        # 例：self.encoding = 'gbk'
        self.encoding = 'gbk'
    ...
    def get_detail_page_urls(self, data):
        ...
        if data is not None:
            ...
            loops = data.xpathall('''//ul[@class="new"]/li''')
    ...
    def get_detail_page_info(self, data):
        ...
        content1 = data.xpathall('''//div[@class="con_wz"]''')
        ...
        pic_urls_list = data.xpathall('''//div[@class="con_wz"]//img/@src''')
        if pic_urls_list:
