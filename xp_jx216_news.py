...
class MySpider(spiderDefault.Spider):
    ...
    def get_detail_page_urls(self, data):
        ...
        if data is not None:
            ...
            loops = data.xpathall('''//div[@class="txt_left"]//ul[@class="txtlist"]/li''')
    ...
    def get_detail_page_info(self, data):
        ...
        channel = data.xpath('''//div[@class="cut_location"]/a[2]//text()''').text().strip()
        ...
        content1 = data.xpathall('''//div[@class="wen_txt"]''')
        ...
        pic_urls_list = data.xpathall('''//div[@class="wen_txt"]//img/@src''')
        if pic_urls_list:
