...
class MySpider(spiderDefault.Spider):
    ...
    def __init__(self, cmd_args=None):
        ...
        self.siteName = '茶陵百事通'
        # 网站一级域名
        self.site_domain = 'chaling.cn'

        self.start_urls = [
            # 列表页链接
            'http://www.chaling.cn/article/list_0_s0_p1.html',#   新闻资讯
            'http://www.chaling.cn/article/list_386_s0_p1.html',#重要通知
            'http://www.chaling.cn/article/list_386_s2965_p1.html',#公告
            'http://www.chaling.cn/article/list_87_s0_p1.html',  #茶陵事
            'http://www.chaling.cn/article/list_385_s0_p1.html',  #茶陵人
            'http://www.chaling.cn/article/list_2955_s0_p1.html',#茶陵物
    ...
    def get_detail_page_urls(self, data):
        ...
        if data is not None:
            ...
            loops = data.xpathall('''//div[@class="con"]/h3/a''')
            ...
            for item in loops:  # 这时的item可以看做将解析到的模块当做新的网页打开，页面内只有解析到的模块，以解析的模块为顶级节点进行解析，而不再是标签
                ...
                if not post_url:
                    continue
                post_url = urljoin('http://www.chaling.cn/article', post_url)
    ...
    def get_detail_page_info(self, data):
        ...
        content1 = data.xpathall('''//div[@class="con"]''')
        ...
        pic_urls_list = data.xpathall('''//div[@class="con"]//img/@src''')
        if pic_urls_list:
