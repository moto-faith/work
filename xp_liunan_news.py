...
class MySpider(spiderDefault.Spider):
    ...
    def __init__(self, cmd_args=None):
        ...
        self.info_flag = "01"
        # 网站名称
        self.siteName = '柳州市柳南区人民政府门户网站'
        # 网站一级域名
        self.site_domain = 'liunan.gov.cn'

        self.start_urls = [
            # 列表页链接
            'http://www.liunan.gov.cn/lnzx/lnyw/',#柳南要闻
            'http://www.liunan.gov.cn/lnzx/bmdt/',#部门动态
            'http://www.liunan.gov.cn/lnzx/jcdt/',# 基层动态
            'http://www.liunan.gov.cn/lnzx/tzgg/',#通知公告
            'http://www.liunan.gov.cn/lnzx/gwyxx/',#国务院信息
    ...
    def get_detail_page_urls(self, data):
        ...
        if data is not None:
            ...
            loops = data.xpathall('''//div[@class="ny_dpwzlb m_txt_list"]//a''')
    ...
    def get_detail_page_info(self, data):
        ...
        content1 = data.xpathall('''//div[@class="xwnr"]''')
        ...
        pic_urls_list = data.xpathall('''//div[@class="xwnr"]//img/@src''')
        if pic_urls_list:
