...
class MySpider(spiderDefault.Spider):
    ...
    def get_detail_page_urls(self, data):
        ...
        if data is not None:
            ...
            loops = data.xpathall('''//td[2]//table[2]//tr/td/table''')
    ...
    def get_detail_page_info(self, data):
        ...
        channel = data.xpath('''//td[@class="Color_01"]//text()''').text().strip()
        ...
        content1 = data.xpathall('''//div[@class="content"]//p''')
