...
class MySpider(spiderDefault.Spider):
    ...
    def __init__(self, cmd_args=None):
        ...
        self.siteName = '绍兴汽车网'
        # 网站一级域名
        self.site_domain = 'car0575.com'

        self.start_urls = [
            # 列表页链接
            'http://www.car0575.com/news/shaoxing/', #绍兴车市
            'http://www.car0575.com/news/jiangjia/',  # 降价优惠
            'http://www.car0575.com/news/hangqing/',  # 行业资讯
            'http://www.car0575.com/news/shangjia/', #商家资讯
            'http://www.car0575.com/news/interview/',#精英访谈
            'http://www.car0575.com/news/chezhan/' #绍兴车展
        ]
        # 网页编码
        # 例：self.encoding = 'gbk'
        self.encoding = 'utf-8'
    ...
    def get_detail_page_urls(self, data):
        ...
        if data is not None:
            ...
            loops = data.xpathall('''//ul[@class="title-list"]/li/a''')
    ...
    def get_detail_page_info(self, data):
        ...
        retweeted_source =data.xpath('''//div[@class="time-s"]/a//text()''').text().strip() or  self.siteName
