...
class MySpider(spiderDefault.Spider):
    ...
    def __init__(self, cmd_args=None):
        ...
        self.info_flag = "01"
        # 网站名称
        self.siteName = '广东省教育厅'
        # 网站一级域名
        self.site_domain = 'gdedu.gov.cn'

        self.start_urls = [
            # 列表页链接
            'http://www.gdedu.gov.cn/publicfiles//business/htmlfiles/gdjyt/tzgg/index.html', # 通知公告
            'http://www.gdedu.gov.cn/publicfiles//business/htmlfiles/gdjyt/btxx/index.html',  # 本厅信息
            'http://www.gdedu.gov.cn/publicfiles//business/htmlfiles/gdjyt/xwfb/index.html',  # 新闻发布
            'http://www.gdedu.gov.cn/publicfiles//business/htmlfiles/gdjyt/mtjj/index.html', #媒体聚焦
            'http://www.gdedu.gov.cn/publicfiles//business/htmlfiles/gdjyt/gdjy/index.html',#广东教育
            'http://www.gdedu.gov.cn/publicfiles//business/htmlfiles/gdjyt/jydt/index.html', # 教育动态
            'http://www.gdedu.gov.cn/publicfiles//business/htmlfiles/gdjyt/tpxw/index.html', # 图片新闻
        ]
        # 网页编码
        # 例：self.encoding = 'gbk'
        self.encoding = 'utf-8'
    ...
    def get_detail_page_urls(self, data):
        ...
        if data is not None:
            ...
            # loops = data.xpathall('''//div[@class="list_li"]''')
            ...
            for item in re.findall('<InfoURL>(.*?)</InfoURL>',data.response.text):
                ...
                # if not post_url:
                #     continue
                post_url = urljoin("http://www.gdedu.gov.cn/publicfiles/business/htmlfiles/",item)
    ...
    def get_detail_page_info(self, data):
        ...
        retweeted_source =data.xpath('''//td[5]//text()''').text().strip() or self.siteName
        ...
        content1 = data.xpathall('''//div[@class="concent_center"]''')
        ...
        pic_urls_list = data.xpathall('''//div[@class="concent_center"]//img/@src''')
        if pic_urls_list:
