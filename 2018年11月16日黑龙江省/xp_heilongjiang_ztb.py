...
class MySpider(spider.Spider):
    def __init__(self,
        ...
        # 网站名称
        self.siteName = "黑龙江公共资源交易网"
        # 类别码，01新闻、02论坛、03博客、04微博 05平媒 06微信  07 视频、99搜索引擎
        self.info_flag = "99"

        # 入口地址列表
        # self.start_urls = ["http://www.bidcenter.com.cn/viplist-1.html"]
        self.start_urls = ["http://www.hljggzyjyw.gov.cn/"]
        self.encoding = 'utf-8'
        self.site_domain = 'hljggzyjyw.gov.cn'
        self.dedup_uri = None
        self.headers = {
    ...
    def parse(self, response, url):
        ...
        url_list = [
            ...
            'http://www.hljggzyjyw.gov.cn/trade/tradezfcg?cid=17&type=4',
            # 政府采购中标公告
            ...
            'http://www.hljggzyjyw.gov.cn/trade/tradezfcg?cid=19&type=4',
            # 国有产权中标公告
...
#         dates = data.xpathall('//span[@class="article-list-date"]/text()')
    ...
    def getdumps(self, url):
        if self.conn.sismember("dumps:hljggzyjyw", url):
            return True  # 在里面
        else:
            print "入redis：去重库"
            self.conn.sadd("dumps:hljggzyjyw", url)
            return False
...
if __name__ == '__main__':
    ...
    url = "http://www.hljggzyjyw.gov.cn/trade/tradezfcg?cid=16&type=1"
