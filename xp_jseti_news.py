...
class MySpider(spiderDefault.Spider):
    ...
    def __init__(self, cmd_args=None):
        ...
        self.info_flag = "01"
        # 网站名称
        self.siteName = '江苏经贸职业技术学院校园网站'
        # 网站一级域名
        self.site_domain = 'jseti.edu.cn'

        self.start_urls = [
            # 列表页链接
            'http://www.jseti.edu.cn/s/21/t/105/p/71/list.htm',
            'http://www.jseti.edu.cn/s/21/t/105/p/72/list.htm',
            'http://www.jseti.edu.cn/s/21/t/105/p/73/list.htm',
            'http://www.jseti.edu.cn/s/21/t/105/p/13/list.htm',
        ]
        # 网页编码
        # 例：self.encoding = 'gbk'
        self.encoding = 'utf-8'
    ...
    def get_detail_page_urls(self, data):
        ...
        if data is not None:
            ...
            loops = data.xpathall('''//div[@class="entry"]/table[1]//tr''')
            self.channel = data.xpath('''//h3[@class="name"]/span/text()''').text().strip()
    ...
    def get_detail_page_info(self, data):
        ...
        ctime = data.xpath('''//span[@class="posttime"]//text()''').regex('\d+-\d+-\d+').datetime()
        # ctime = gtime
        if ctime < self.c_time:
            return None
        ...
        retweeted_source = data.xpath('''//p[@class="postmeta"]/span[3]//text()''').text().strip() or self.siteName
        ...
        content1 = data.xpathall('''//div[@class="entry1"]''')
        ...
        pic_urls_list = data.xpathall('''//div[@class="entry1"]//img/@src''')
        if pic_urls_list:
