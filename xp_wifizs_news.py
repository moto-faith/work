...
class MySpider(spiderDefault.Spider):
    ...
    def __init__(self, cmd_args=None):
        ...
        self.siteName = '无限舟山'
        # 网站一级域名
        self.site_domain = 'wifizs.cn'

        self.start_urls = [
            # 列表页链接
            'http://www.wifizs.cn/folder1/folder127/', # 新闻>舟山
            'http://www.wifizs.cn/folder1/folder126/', # 新闻>天下
            'http://www.wifizs.cn/folder1/folder184/', # 新闻>娱乐
            'http://www.wifizs.cn/folder1/folder156/', # 新闻>活动
        ]
        # 网页编码
        # 例：self.encoding = 'gbk'
        self.encoding = 'utf-8'
    ...
    def get_detail_page_urls(self, data):
        ...
        if data is not None:
            ...
            loops = data.xpathall('''//div[@class="clearfix jz_more"]//div[@class="yd"]''')
    ...
    def get_detail_page_info(self, data):
        ...
        channel = data.xpath('''//div[@class="currPosition qh"]//li[3]//text()''').text().strip()
