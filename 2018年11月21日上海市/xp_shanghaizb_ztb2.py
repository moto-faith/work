...
class MySpider(spider.Spider):
    ...
    def parse(self, response, url):
        ...
        #     urls = []
        page_urls = []
        urls = self.db.table(self.result1).where('''tf = "1" and siteName = "上海市建设工程交易服务中心"''').find()
...
if __name__ == '__main__':
    ...
    # ------------ parse_detail_page() ----------
    url = "https://www.ciac.sh.cn/XmZtbbaWeb/gsqk/ZbjgGk.aspx?zbid=101136"
    resp = spider.download(url)
