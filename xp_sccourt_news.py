...
class MySpider(spiderDefault.Spider):
    ...
    def __init__(self, cmd_args=None):
        ...
        self.info_flag = "01"
        # 网站名称
        self.siteName = '四川省高级人民法院'
        # 网站一级域名
        self.site_domain = 'sccourt.gov.cn'

        self.start_urls = [
            # 列表页链接
            'http://www.sccourt.gov.cn/xwzx/index.html',#新闻中心
            'http://www.sccourt.gov.cn/xwzx/fyyw/index.html',#要闻
            'http://www.sccourt.gov.cn/xwzx/fydt/index.html',#法院动态
            'http://www.sccourt.gov.cn/xwzx/xwfb/index.html',#新闻发布
            'http://www.sccourt.gov.cn/xwzx/mtjj/index.html',#媒体聚焦
        ]
        # 网页编码
        # 例：self.encoding = 'gbk'
    ...
    def get_detail_page_urls(self, data):
        ...
        if data is not None:
            ...
            loops = data.xpathall('''//td[@width="85%"]''')
    ...
    def get_detail_page_info(self, data):
        ...
        content1 = data.xpathall('''//td[@height="500"]''')
        ...
        pic_urls_list = data.xpathall('''//td[@height="500"]//img/@src''')
        if pic_urls_list:
