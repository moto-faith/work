...
class MySpider(spiderDefault.Spider):
    ...
    def __init__(self, cmd_args=None):
        ...
        self.siteName = '淘狗网'
        # 网站一级域名
        self.site_domain = 'dog126.com'

        self.start_urls = [
            # 列表页链接
            'http://www.dog126.com/article_list_1.html', #焦点热门
            'http://www.dog126.com/article_list_227.html',  # 课堂训练
            'http://www.dog126.com/article_list_142.html',  # 养护
            'http://www.dog126.com/article_list_22.html',  # 泰迪犬
            'http://www.dog126.com/article_list_47.html',  # 哈士奇犬
            'http://www.dog126.com/article_list_75.html',  # 藏獒犬
            'http://www.dog126.com/article_list_13.html',  # 萨摩耶犬
            'http://www.dog126.com/article_list_27.html',  # 拉布拉多犬
            'http://www.dog126.com/article_list_10.html',  # 金毛犬
            'http://www.dog126.com/article_list_12.html',  # 比熊犬
            'http://www.dog126.com/article_list_15.html',  # 阿拉斯加雪橇犬
            'http://www.dog126.com/article_list_14.html',  # 贵宾犬
            'http://www.dog126.com/article_list_58.html',  # 秋田犬
            'http://www.dog126.com/article_list_19.html',  # 高加索犬
            'http://www.dog126.com/article_list_17.html',  # 松狮犬
            'http://www.dog126.com/article_list_9.html',  # 博美犬
            'http://www.dog126.com/article_list_93.html',  # 巴哥犬
            'http://www.dog126.com/article_list_30.html',  # 阿富汗犬
            'http://www.dog126.com/article_list_42.html',  # 大丹犬
            'http://www.dog126.com/article_list_11.html',  # 苏格兰牧羊犬
            'http://www.dog126.com/article_list_24.html',  # 喜乐蒂犬
            'http://www.dog126.com/article_list_41.html',  # 斗牛犬
    ...
    def get_detail_page_urls(self, data):
        ...
        if data is not None:
            ...
            loops = data.xpathall('''//span[@class="sTit"]''')
            for item in loops:  # 这时的item可以看做将解析到的模块当做新的网页打开，页面内只有解析到的模块，以解析的模块为顶级节点进行解析，而不再是标签
                ...
                post_url = item.xpath('''//em[@class="eTit"]//a//@href''').text().strip()
                if not post_url:
                    continue
                post_url = urljoin("http://www.dog126.com", post_url)
    ...
    def get_detail_page_info(self, data):
        ...
        retweeted_source =data.xpath('''//p[@class="info"]/span[2]//text()''').text().strip() or self.siteName
        ...
        content1 = data.xpathall('''//div[@class="content"]''')
        ...
        pic_urls_list = data.xpathall('''//div[@class="content"]//img/@src''')
        if pic_urls_list:
        ...
        post = {
            ...
            'ctime': ctime,
            'source': source,
            'retweeted_source': retweeted_source[9:],
            'channel': channel,
