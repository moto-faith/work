...
class MySpider(spiderDefault.Spider):
    ...
    def __init__(self, cmd_args=None):
        ...
        self.siteName = '吉林林业网'
        # 网站一级域名
        self.site_domain = 'jlforestry.gov.cn'

        self.start_urls = [
            # 列表页链接
            'http://lyt.jl.gov.cn/xwgg_lyt/lyxw_lyt/hyyw_lyt/', #行业要闻
            'http://lyt.jl.gov.cn/xwgg_lyt/lyxw_lyt/sndt_lyt/',  # 省内动态
            'http://lyt.jl.gov.cn/xwgg_lyt/tzgg_lyt/zyyl_lyt/',#重要言论
            'http://lyt.jl.gov.cn/xwgg_lyt/tzgg_lyt/gsgg_lyt/',#公示公告
            'http://lyt.jl.gov.cn/xwgg_lyt/tzgg_lyt/zbgg_lyt/',#招标公告
            'http://lyt.jl.gov.cn/xwgg_lyt/zyhy/tbjhy/',# 厅本级会议
            'http://lyt.jl.gov.cn/xwgg_lyt/zyhy/jchy/',  #基层会议
        ]
        # 网页编码
        # 例：self.encoding = 'gbk'
        self.encoding = 'utf-8'
    ...
    def get_detail_page_urls(self, data):
        ...
        if data is not None:
            ...
            loops = data.xpathall('''//div[@class="news_list"]//a''')
    ...
    def get_detail_page_info(self, data):
        ...
        retweeted_source = data.xpath('''//div[@class="zhengwen"]/h2/div[2]/text()''').text().strip() or self.siteName
