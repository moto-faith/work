...
class MySpider(spiderDefault.Spider):
    ...
    def get_detail_page_urls(self, data):
        ...
        if data is not None:
            ...
            loops = data.xpathall('''//div[@class="pingd"]//li''')
    ...
    def get_detail_page_info(self, data):
        ...
        ctime = data.xpath('''//div[@class="nytext-1"]''').datetime()
        # ctime = gtime
        if ctime < self.c_time:
            return None
        ...
        content1 = data.xpathall('''//div[@id="MyContent"]''')
        ...
        pic_urls_list = data.xpathall('''//div[@id="MyContent"]//img/@src''')
        if pic_urls_list:
