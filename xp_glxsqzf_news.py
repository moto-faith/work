...
class MySpider(spiderDefault.Spider):
    ...
    def __init__(self, cmd_args=None):
        ...
        self.info_flag = "01"
        # 网站名称
        self.siteName = '象山区人民政府门户网站'
        # 网站一级域名
        self.site_domain = 'glxsqzf.gov.cn'

        self.start_urls = [
            # 列表页链接
            'http://www.glxsqzf.gov.cn/jrxsn/xsdt/',#象山动态
            'http://www.glxsqzf.gov.cn/jrxsn/csjs/',#城市建设
            'http://www.glxsqzf.gov.cn/jrxsn/zsyz/tzdt/',# 投资动态
            'http://www.glxsqzf.gov.cn/jrxsn/csjs/',#城市建设
            'http://www.glxsqzf.gov.cn/jrxsn/jyjj_8011/zcwj/',  #政策文件
            'http://www.glxsqzf.gov.cn/jrxsn/xsqy_8012/',#象山企业
            'http://www.glxsqzf.gov.cn/jrxsn/rszl/',#人社专栏
    ...
    def get_detail_page_urls(self, data):
        ...
        if data is not None:
            ...
            loops = data.xpathall('''//td[@height="28"]/a''')
    ...
    def get_detail_page_info(self, data):
        ...
        content1 = data.xpathall('''//td[@id="FontResize"]''')
        ...
        pic_urls_list = data.xpathall('''//td[@id="FontResize"]//img/@src''')
        if pic_urls_list:
