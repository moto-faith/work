...
class MySpider(spiderDefault.Spider):
    ...
    def __init__(self, cmd_args=None):
        ...
        self.info_flag = "01"
        # 网站名称
        self.siteName = '建设行业信息网'
        # 网站一级域名
        self.site_domain = 'chinajsxx.com'

        self.start_urls = [
            # 列表页链接
            'http://news.chinajsxx.com/',
    ...
    def get_detail_page_urls(self, data):
        ...
        if data is not None:
            ...
            loops = data.xpathall('''//li[@class="tit"]''')
    ...
    def get_detail_page_info(self, data):
        ...
        title = data.xpath('''//h2[@class="biaoti"]//text()''').text().strip()
        ...
        channel = data.xpath('''//h3[@class="list-h3sz"]/a[2]//text()''').text().strip()
        ...
        retweeted_source = data.xpath('''//ul[@class="xinxi"]/li[2]''').text().strip() or self.siteName
        ...
        content1 = data.xpathall('''//div[@class="nr"]''')
        ...
        pic_urls_list = data.xpathall('''//div[@class="nr"]//img/@src''')
        if pic_urls_list:
