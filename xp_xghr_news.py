...
class MySpider(spiderDefault.Spider):
    ...
    def __init__(self, cmd_args=None):
        ...
        self.info_flag = "01"
        # 网站名称
        self.siteName = '孝感公共招聘网'
        # 网站一级域名
        self.site_domain = 'xghr.net.cn'
    ...
    def get_detail_page_urls(self, data):
        ...
        if data is not None:
            ...
            loops = data.xpathall('''//div[@class="listbox"]//div[@class="txt link_lan"]''')
    ...
    def get_detail_page_info(self, data):
        ...
        content1 = data.xpathall('''//div[@class="txt"]/p''')
        ...
        pic_urls_list = data.xpathall('''//div[@class="txt"]//img/@src''')
        if pic_urls_list:
